// WinService.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "WinServiceWinService.h"
...
//To install/uninstall the service, type: "WinService.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew WinServiceWinService());
	}
}
