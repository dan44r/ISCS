...
var gcCalBG = "#14aa14"; // the background color of the outer calendar panel.
...
var gcSatBG = "#82CF81"; // Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG = "#82CF81"; // Sunday background color
