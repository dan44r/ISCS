<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageShipFromWarehousePop.aspx.cs"
    Inherits="ISCS.Admin.ManageShipFromWarehousePop" Theme="Admin" %>
                ...
                <div class="whiteBox userListPan">
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span style="padding-top: 10px;"><a href="ManageShipFromWarehousePop.aspx">View All</a></span>
                                </td>
                                <td align="right">
                                    <a href="#">&nbsp;</a>
                                </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkmaskedskidClick" Text='<%# Eval("maskedskid")%>' runat="server"
                                                            ...
                                                            PostBackUrl="~/Admin/ManageShipFromWarehouseSkuPop.aspx"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                    <HeaderTemplate>
                                        ...
                                        <asp:HiddenField ID="hidFSkuid_SI" runat="server" />
                                        <asp:HiddenField ID="hidPickReqId" runat="server" />
                                    </div>
                                </td>
                            </tr>
                        </tbody>
