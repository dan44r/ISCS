    ...
    public partial class AddPickUpRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    //txtBillToAddress.Text = "900 Rt. 134, Suite 2-17";
            ...
            rbDomeGround.InputAttributes["class"] = "redio";
            rbDomeAir.InputAttributes["class"] = "redio";
            rbISCSAdvantage.InputAttributes["class"] = "redio";
            btnloadskids.Attributes.Add("onclick", "javascript:CallMe();");
            drpDomesticGround.Attributes.Add("disabled", "true");
            drpDomesticAir.Attributes.Add("disabled", "true");
            rbDomeGround.Attributes.Add("onclick", "EnableModeOfTransport('rbDomeGround');");
            rbDomeAir.Attributes.Add("onclick", "EnableModeOfTransport('rbDomeAir');");

            //if (drpBillToCompany.SelectedItem.Text.Trim().ToLower().IndexOf("impact") != -1)
        ...
        protected void BindControls()
        {
            ...
            drpToState.DataSource = dsStates.Tables[0];
            drpToState.DataValueField = "StateId";
            drpToState.DataTextField = "Name";
            drpToState.DataBind();
            drpToState.Items.Insert(0, lstItem);
            ...
            drpDomesticGround.Items.Add(new ListItem("None", "N/A"));
            drpDomesticGround.Items.Add(new ListItem("LTL (Less Than Load)", "LTL"));
            drpDomesticGround.Items.Add(new ListItem("FTL (Full Truck Load)", "FTL"));
            drpDomesticGround.Items.Add(new ListItem("Flatbed", "Flatbed"));
            drpDomesticGround.Items.Add(new ListItem("Padded Van", "Padded Van"));
            drpDomesticGround.Items.Add(new ListItem("Same Day Expedited", "Same Day Expedited"));
            drpDomesticGround.Items.Add(new ListItem("Time Definitive (Less Than Load)", "Time Definitive LTL"));
            drpDomesticGround.Items.Add(new ListItem("Time Definitive (Full Truck Load)", "Time Definitive FTL"));
            drpDomesticGround.Items.Add(new ListItem("Refrigerated (Less Than Load)", "Refrigerated LTL"));
            drpDomesticGround.Items.Add(new ListItem("Refrigerated (Full Truck Load)", "Refrigerated FTL"));
            drpDomesticGround.Items.Add(new ListItem("Frozen (Less Than Load)", "Frozen LTL"));
            drpDomesticGround.Items.Add(new ListItem("Frozen (Full Truck Load)", "Frozen FTL"));
            drpDomesticGround.Items.Add(new ListItem("Inter-modal", "Inter-modal"));

            drpDomesticAir.Items.Add(new ListItem("None", "N/A"));
            drpDomesticAir.Items.Add(new ListItem("Same day", "Same day"));
            drpDomesticAir.Items.Add(new ListItem("Next Day by 10:30 AM", "Next Day by 10:30 AM"));
            drpDomesticAir.Items.Add(new ListItem("Next Day by 12:00 AM", "Next Day by 12:00 AM"));
            drpDomesticAir.Items.Add(new ListItem("Next Day By 5:00 PM", "Next Day By 5:00 PM"));
            drpDomesticAir.Items.Add(new ListItem("2nd day", "2nd day"));
            drpDomesticAir.Items.Add(new ListItem("Deferred (3-5 Day)", "Deferred"));
            ...
            //drpBillToCompany.Items.Add("Impact Supply Chain Solutions");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (CommonBL.isDate(txtPickUpDate.Text.ToString().Trim()) == true && CommonBL.isDate(txtDeliveryDate.Text.ToString().Trim()) == true)
            {
                ...
                if (drpToState.SelectedIndex > 0)
                {
                    objEL.ShipToState = drpToState.SelectedItem.Text;
                }
                else
                {
                    objEL.ShipToState = "";
                ...
                objEL.ShipToNotifyName = txtAlsoNotify.Text.ToString().Trim();
                objEL.ShipToNotifyPhone = txtToTelephone.Text.ToString().Trim();
                ...
                if (chkSaveShipToInfo.Checked)
                {
                    ...
                    if (drpToState.SelectedIndex > 0)
                    {
                        objUserLocationEL.StateId = IsInteger(drpToState.SelectedValue);
                    }
                    ...
                    objUserLocationEL.AlsoNotifyName = txtAlsoNotify.Text.ToString().Trim();
                    objUserLocationEL.AlsoNotifyPhone = txtToTelephone.Text.ToString().Trim();
                    Boolean statUL = UserLocationBL.AddLocation(objUserLocationEL);
                }
                // Add Userlocation for future use
        ...
        protected void btnContinue_Click(object sender, EventArgs e)
        {
            if (CommonBL.isDate(txtPickUpDate.Text.ToString().Trim()) == true && CommonBL.isDate(txtDeliveryDate.Text.ToString().Trim()) == true)
            {
                ...
                objEL.ShipToNotifyPhone = txtToTelephone.Text.ToString().Trim();
                objEL.ShipToDate = Convert.ToDateTime(txtDeliveryDate.Text.ToString().Trim());
                //Commented to keep track of pick up initiator
                //objEL.UserId = IsInteger(Convert.ToString(Session["cacheUserId"]));                
                ...
                if (rbDomeGround.Checked == true)
                {
                    objEL.TransMode = 1;
                    objEL.TransModeName = rbDomeGround.Text;
                }
                else if (rbDomeAir.Checked == true)
                {
                    objEL.TransMode = 2;
                    objEL.TransModeName = rbDomeAir.Text;
                ...
                objEL.TransModeService1 = drpDomesticGround.SelectedItem.Value;
                objEL.TransModeService2 = drpDomesticAir.SelectedItem.Value;
                string strSServices = "";
                ...
                objEL.GLSTotalBuyRate = IsDecimal(txtTransportCost1.Text.ToString().Trim()) + IsDecimal(txtTransportCost2.Text.ToString().Trim()) + IsDecimal(txtTransportCost3.Text.ToString().Trim()) + IsDecimal(txtTransportCost4.Text.ToString().Trim()) + IsDecimal(txtAccessorialCost1.Text.ToString().Trim())
                    ...
                    IsDecimal(txtFuelSurcharge3.Text.ToString().Trim()) + IsDecimal(txtFuelSurcharge4.Text.ToString().Trim()) + IsDecimal(txtInsurance1.Text.ToString().Trim()) + IsDecimal(txtCodFee1.Text.ToString().Trim());

                objEL.GLSTotalSellRate = IsDecimal(txtTransport.Text.ToString().Trim()) + IsDecimal(txtAccessorial.Text.ToString().Trim()) + IsDecimal(txtFuelSurcharge.Text.ToString().Trim()) + IsDecimal(txtInsurance.Text.ToString().Trim()) + IsDecimal(txtCodFee.Text.ToString().Trim());
                ...
                if (stat == true)
                {
                    ...
                    {
                        Response.Write("<script language='javascript'>alert('Record saved successfully');location.href='AddPickUpRequest.aspx';</script>");
                    }
                }
            }
            else
        ...
        {
            string QBXML = string.Empty;
            string QBCustomerAdd = string.Empty;
            string QBCustomerAmtAdd = string.Empty;
            string QBVendorAdd = string.Empty;
            string QBVendorAmtAdd = string.Empty;
            if (CommonBL.isDate(txtPickUpDate.Text.ToString().Trim()) == true && CommonBL.isDate(txtDeliveryDate.Text.ToString().Trim()) == true)
            {
                PickupRequestEL objEL = new PickupRequestEL();
                objEL.PickupRequestId = IsInteger(ViewState["PickupReuestId"].ToString());
                ...
                if (stat == true)
                {
                    //when delivery location is warehouse
                    if (HidWarehouseid.Value != null && HidWarehouseid.Value != "" && HidWarehouseid.Value != "0")
                    {
                    ...
                    //string strAcceptEmails = "";

                    //DataSet dsAcceptEmails = UserBL.GetAllEmailsByAccountCodes(txtFromEmail.Text.ToString().Trim());
                    //if (dsAcceptEmails != null) 
                    //{
                    //    if(dsAcceptEmails.Tables[0].Rows.Count > 0)
                    //    {
                    //        for (int i = 0; i < dsAcceptEmails.Tables[0].Rows.Count; i++)
                    //        {
                    //            strAcceptEmails += Convert.ToString(dsAcceptEmails.Tables[0].Rows[i]["AcceptEmail"]) + ",";
                    //        }
                    //    }
                    //}
                    LockPickupRequest(IsInteger(ViewState["PickupReuestId"].ToString()), IsInteger(Convert.ToString(Session["cacheUserId"])), false);
                    ...
                    //RequestAcceptByISCS(objTBillsEL.tracking_no, txtFromEmail.Text.ToString().Trim(), strAcceptEmails.Trim(), objEL.GLSTotalSellRate, Convert.ToInt32(drpAccountCode.SelectedValue));
                    string QWEVendor2QuickBook = "";
                    string Vendor2QuickBook = "";
                    if (drpBillToCompany.SelectedItem.Text.Trim().ToUpper().IndexOf("QUAD") != -1)
                    {
                        //RequestAcceptByISCS(objTBillsEL.tracking_no, ConfigurationManager.AppSettings["QWEEmail"].Trim(), ConfigurationManager.AppSettings["QWEEmail"].Trim(), objEL.GLSTotalSellRate, Convert.ToInt32(drpAccountCode.SelectedValue));
                        ...
                        QWEVendor2QuickBook = AddQWEVendor2QuickBook(objTBillsEL.tracking_no); //Commented on 25.04.2012 Client Request(Disable QB)
                    }
                    else
                    {
                        Vendor2QuickBook = AddVendor2QuickBook(objTBillsEL.tracking_no); //Commented on 25.04.2012 Client Request(Disable QB)
                    }
                    string CustomerQB = AddCustomer2QuickBook(objTBillsEL.tracking_no); //Commented on 25.04.2012 Client Request(Disable QB)
                    string[] strSplit = CustomerQB.Split('/');
                    QBCustomerAdd = strSplit[0].ToString();
                    QBCustomerAmtAdd = strSplit[1].ToString();

                    if (QWEVendor2QuickBook != "")
                    {
                        string[] strSplit1 = QWEVendor2QuickBook.Split('/');
                        QBXML = strSplit1[0].ToString();
                        QBVendorAmtAdd = strSplit1[1].ToString();
                    }

                    if (Vendor2QuickBook != "")
                    {
                        string[] strSplit2 = Vendor2QuickBook.Split('/');
                        QBVendorAdd = strSplit2[0].ToString();
                        QBVendorAmtAdd = strSplit2[1].ToString();
                    }


                    QBXmlFileBL.InsertQBXMLFile(objTBillsEL.tracking_no, QBXML, QBCustomerAdd, QBCustomerAmtAdd, QBVendorAdd, QBVendorAmtAdd);
                    Response.Write("<script language='javascript'>alert('The request has been accepted');location.href='AddPickUpRequest.aspx';</script>");
                }
                else
                {
        ...
        #region protected void gridHandlingUnits_RowCommand(object sender, GridViewCommandEventArgs e)
        protected void gridHandlingUnits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        #region protected void gridShipments_RowCommand(object sender, GridViewCommandEventArgs e)
        ...
        protected void FetchAllValues(string strRequestId)
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    for (int i = 0; i < drpToState.Items.Count; i++)
                    {
                        if (drpToState.Items[i].Text == ds.Tables[0].Rows[0]["ShipToState"].ToString())
                        {
                            drpToState.ClearSelection();
                            drpToState.Items[i].Selected = true;
                        }
                    }
                }
                ...
                txtAlsoNotify.Text = ds.Tables[0].Rows[0]["ShipToNotifyName"].ToString();
                txtToTelephone.Text = ds.Tables[0].Rows[0]["ShipToNotifyPhone"].ToString();
                ...
                {
                    if (Convert.ToInt32(ds.Tables[0].Rows[0]["TransMode"]) == 1)
                    {
                        rbISCSAdvantage.Checked = false;
                        rbDomeGround.Checked = true;
                    }
                    else if (Convert.ToInt32(ds.Tables[0].Rows[0]["TransMode"]) == 2)
                    {
                        rbISCSAdvantage.Checked = false;
                        rbDomeAir.Checked = true;
                    }
                    else
                    {
                ...
                {
                    for (int i = 0; i < drpDomesticGround.Items.Count; i++)
                    {
                        if (drpDomesticGround.Items[i].Value == ds.Tables[0].Rows[0]["TransModeService1"].ToString())
                        {
                            drpDomesticGround.ClearSelection();
                            drpDomesticGround.Items[i].Selected = true;
                        }
                    }
                }
                ...
                {
                    for (int i = 0; i < drpDomesticAir.Items.Count; i++)
                    {
                        if (drpDomesticAir.Items[i].Value == ds.Tables[0].Rows[0]["TransModeService2"].ToString())
                        {
                            drpDomesticAir.ClearSelection();
                            drpDomesticAir.Items[i].Selected = true;
                        }
                    }
                }

                if (ds.Tables[0].Rows[0].IsNull("SpecialServiceCodes") == false && ds.Tables[0].Rows[0].IsNull("SpecialServiceCodes").ToString() != "")
                {
        ...
        //protected void RequestAcceptByISCS(string strTrackingNo, string strToMail,string AcceptEmails, decimal dGLSTotalSellRate,int iGLSAccountId)
        protected void RequestAcceptByISCS(string strTrackingNo, string strToMail, string InitiatorEmail, decimal dGLSTotalSellRate, int iGLSAccountId, int InitiatorUserTypeID)
        {
            ...
            sbMailBody.Append("</td></tr>");
            sbMailBody.Append("<tr><td>" + txtToCity.Text.ToString().Trim() + "," + drpToState.SelectedItem.Text);
            sbMailBody.Append("</td></tr>");
            ...
            if (dsCompareAccountCodes != null && dsCompareAccountCodes.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    ShipperAccountCodeId = IsInteger(Convert.ToString(dsCompareAccountCodes.Tables[0].Rows[i]["AccountCodeId"]));
            ...
            if (rbDomeGround.Checked == true)
            {
                sbMailBody.Append("<tr><td>Service Level: " + drpDomesticGround.SelectedValue);
            }
            else if (rbDomeAir.Checked == true)
            {
                sbMailBody.Append("<tr><td>Service Level: " + drpDomesticAir.SelectedValue);
            }
            else
            {
            ...
            if (Session["userEmail"] != null)
            {
                ...
                //CommonBL.sendMailInHtmlFormat("admin@impact-scs.com", AcceptEmails, "Impact Supply Chain Solution Pickup Request Confirmation", sbMailBody.ToString());
            }
        }
        #endregion
        ...
        protected void AdminEmailNewRequest(string strToMail)
        {
            ...
            sbMailBody.Append("</td></tr>");
            string strUrlPickRequest = strMainURL + "/Admin/AddPickUpRequest.aspx?PickupRequestId=" + SecurityUtils.UrlEncode(ViewState["PickupReuestId"].ToString());
        ...
        public string AddVendor2QuickBook(string strRefNo)
        {
            string strRes4 = "";
            string strRes = "";
            ...
            if (IsInteger(hdCarrierID.Value) > 0 || txtPickupCarrier.Text.Trim() != "" || IsDouble(txtTransportCost1.Text) > 0.00 || IsDouble(txtAccessorialCost1.Text) > 0.00 || IsDouble(txtFuelSurcharge1.Text) > 0.00)
            {
                ...
                strRes = PrepareVendorAddXML(IsInteger(hdCarrierID.Value), "");
                ...
                strRes4 = PrepareVendorAmtAddXML(oQuickBookEL, "");
            }
            if (IsInteger(hdIntermediateCarrierID.Value) > 0 || txtIntermediateCarrier.Text.Trim() != "" || IsDouble(txtTransportCost2.Text) > 0.00 || IsDouble(txtAccessorialCost2.Text) > 0.00 || IsDouble(txtFuelSurcharge2.Text) > 0.00)
            {
                ...
                strRes = PrepareVendorAddXML(IsInteger(hdIntermediateCarrierID.Value), "Intermediate");
                ...
                //string strRes4 = QuickBookBL.VendorAmountADD(oQuickBookEL);
                strRes4 = PrepareVendorAmtAddXML(oQuickBookEL, "Intermediate");
            }
            if (IsInteger(hdDeliveryCarrierID.Value) > 0 || txtDeliveryCarrier.Text.Trim() != "" || IsDouble(txtTransportCost3.Text) > 0.00 || IsDouble(txtAccessorialCost3.Text) > 0.00 || IsDouble(txtFuelSurcharge3.Text) > 0.00)
            {
                ...
                strRes = PrepareVendorAddXML(IsInteger(hdDeliveryCarrierID.Value), "Delivery");
                ...
                //string strRes4 = QuickBookBL.VendorAmountADD(oQuickBookEL);
                strRes4 = PrepareVendorAmtAddXML(oQuickBookEL, "Delivery");
            }
            if (IsInteger(hdOtherCarrierID.Value) > 0 || txtOtherCarrier.Text.Trim() != "" || IsDouble(txtTransportCost4.Text) > 0.00 || IsDouble(txtAccessorialCost4.Text) > 0.00 || IsDouble(txtFuelSurcharge4.Text) > 0.00)
            {
                ...
                strRes = PrepareVendorAddXML(IsInteger(hdOtherCarrierID.Value), "Other");
                ...
                //string strRes4 = QuickBookBL.VendorAmountADD(oQuickBookEL);
                strRes4 = PrepareVendorAmtAddXML(oQuickBookEL, "Other");
            }
            return strRes + "/" + strRes4;
        ...
        #region public void AddCustomer2QuickBook()
        public string AddCustomer2QuickBook(string strRefNo)
        {
            string res = "";
            QuickBookEL oQuickBookEL = new QuickBookEL();
            ...
            oQuickBookEL.CustomerInvoiceDesc = ViewState["shipPiece"].ToString() + " @ " + ViewState["shppedwt"].ToString() + " lbs shipped from " + txtShipFromCompany.Text.Trim() + " in " + txtFromCity.Text.Trim() + ", " + drpFromState.SelectedItem.Text.Trim() + " to " + txtShipToCompany.Text.Trim().Replace("–", "-") + " in " + txtToCity.Text.Trim() + ", " + drpToState.SelectedItem.Text.Trim() + " using ";
            //oQuickBookEL.CustomerInvoiceDesc = ViewState["shipPiece"].ToString() + " @ " + ViewState["shppedwt"].ToString() + " lbs shipped from " + drpAccountCode.SelectedItem.Text.Trim() + " to " + txtShipToCompany.Text.Trim() + " in " + txtToCity.Text.Trim() + ", " + drpToState.SelectedItem.Text.Trim() + " using ";
            oQuickBookEL.CustomerTotalAmt = IsDouble(txtTransport.Text.ToString().Trim()) + IsDouble(txtAccessorial.Text.ToString().Trim()) + IsDouble(txtFuelSurcharge.Text.ToString().Trim()) + IsDouble(txtInsurance.Text.ToString().Trim()) + IsDouble(txtCodFee.Text.ToString().Trim());
            oQuickBookEL.CustomerTotalQty = Convert.ToInt32(ViewState["shipPiece"].ToString());

            if (rbDomeGround.Checked == true)
            {
                oQuickBookEL.CustomerInvoiceDesc += rbDomeGround.Text + ", " + drpDomesticGround.SelectedItem.Text.Trim();
            }
            else if (rbDomeAir.Checked == true)
            {
                oQuickBookEL.CustomerInvoiceDesc += rbDomeAir.Text + ", " + drpDomesticAir.SelectedItem.Text.Trim();
            }
            else if (rbISCSAdvantage.Checked == true)
            {
        ...
        public string PrepareVendorAddXML(int CarrierID, string CarrierType)
        {
            ...
            //QB REST V3 API
            string vendorAddV3 = "";
            vendorAddV3 += @"<Vendor xmlns=""http://schema.intuit.com/finance/v3"" sparse=""false"">";
            vendorAddV3 += "<DisplayName>" + Convert.ToString(dt.Rows[0]["CarrierName"]).Trim().Replace("&", "&amp;") + "</DisplayName>";
            vendorAddV3 += "<Active>true</Active>";
            vendorAddV3 += "<PrimaryPhone>";
            vendorAddV3 += "<FreeFormNumber>" + Convert.ToString(dt.Rows[0]["ContactPhone"]).Trim().Replace("&", "&amp;") + "</FreeFormNumber>";
            vendorAddV3 += "</PrimaryPhone>";
            vendorAddV3 += "<Fax>";
            vendorAddV3 += "<FreeFormNumber>" + Convert.ToString(dt.Rows[0]["ContactFax"]).Trim().Replace("&", "&amp;") + "</FreeFormNumber>";
            vendorAddV3 += "</Fax>";
            vendorAddV3 += "<PrimaryEmailAddr>";
            vendorAddV3 += "<Address>" + Convert.ToString(dt.Rows[0]["ContactEmail"]).Trim().Replace("&", "&amp;") + "</Address>";
            vendorAddV3 += "</PrimaryEmailAddr>";
            vendorAddV3 += "<BillAddr>";
            vendorAddV3 += "<Line1>" + Convert.ToString(dt.Rows[0]["Address"]).Trim().Replace("&", "&amp;") + "</Line1>";
            vendorAddV3 += "<City>" + Convert.ToString(dt.Rows[0]["City"]).Trim().Replace("&", "&amp;") + "</City>";
            vendorAddV3 += "<Country></Country>";
            vendorAddV3 += "<PostalCode>" + Convert.ToString(dt.Rows[0]["PostalCode"]).Trim().Replace("&", "&amp;") + "</PostalCode>";
            vendorAddV3 += "</BillAddr>";
            vendorAddV3 += "</Vendor>";
        ...
        {
            string UnProcessedPath = ConfigurationManager.AppSettings["UnProcessedPath"].ToString();
            string UnProcessedWithoutPronumberPath = ConfigurationManager.AppSettings["UnProcessedWithoutPronumber"].ToString();
            string vendoeAdd = "";
            ...
            //QB REST V3 API
            string vendorAmtAddV3 = "";
            //string iVendorName = oQuickEL.VendorName.Trim().Replace("&", "&amp;");
            //localhost.WebService1 oWebService1 = new localhost.WebService1();
            //string iVendorID = oWebService1.GetVendorID(iVendorName);
            vendorAmtAddV3 += "<Bill xmlns=\"http://schema.intuit.com/finance/v3\" >";

            Decimal GLSTotalBuyRate = IsDecimal(txtTransportCost1.Text.ToString().Trim()) + IsDecimal(txtTransportCost2.Text.ToString().Trim()) + IsDecimal(txtTransportCost3.Text.ToString().Trim()) + IsDecimal(txtTransportCost4.Text.ToString().Trim()) + IsDecimal(txtAccessorialCost1.Text.ToString().Trim())
                    + IsDecimal(txtAccessorialCost2.Text.ToString().Trim()) + IsDecimal(txtAccessorialCost3.Text.ToString().Trim()) + IsDecimal(txtAccessorialCost4.Text.ToString().Trim()) + IsDecimal(txtFuelSurcharge1.Text.ToString().Trim()) + IsDecimal(txtFuelSurcharge2.Text.ToString().Trim())
                    + IsDecimal(txtFuelSurcharge3.Text.ToString().Trim()) + IsDecimal(txtFuelSurcharge4.Text.ToString().Trim())
                    + IsDecimal(txtInsurance1.Text.ToString().Trim())
                    + IsDecimal(txtCodFee1.Text.ToString().Trim());

            if (GLSTotalBuyRate > 0)
            {
                vendorAmtAddV3 += "<Line><Id>" + "1" + "</Id>";
                vendorAmtAddV3 += "<Amount>" + Convert.ToString(GLSTotalBuyRate.ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
                vendorAmtAddV3 += "<Description></Description>";
                vendorAmtAddV3 += "<DetailType>AccountBasedExpenseLineDetail</DetailType><AccountBasedExpenseLineDetail><AccountRef>31</AccountRef></AccountBasedExpenseLineDetail>";// COGS : 31(Live)/57(Test)
                vendorAmtAddV3 += "</Line>";
            }
            /*
            int LineCount = 1;

            if ((oQuickEL.VendorAccessorialAmt1 + oQuickEL.VendorBuyBrokerageAmt1 + oQuickEL.VendorBuyDutyAmt1) > 0)//AccountRef : 14(Miscellaneous)[QB LIVE] / 14(Meals and Entertainment)[QB Test] 
            {
                vendorAmtAddV3 += "<Line><Id>" + LineCount.ToString() + "</Id>";
                vendorAmtAddV3 += "<Amount>" + Convert.ToString((oQuickEL.VendorAccessorialAmt1 + oQuickEL.VendorBuyBrokerageAmt1 + oQuickEL.VendorBuyDutyAmt1).ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
                vendorAmtAddV3 += "<Description></Description>";
                vendorAmtAddV3 += "<DetailType>AccountBasedExpenseLineDetail</DetailType><AccountBasedExpenseLineDetail><AccountRef>14</AccountRef></AccountBasedExpenseLineDetail>";
                vendorAmtAddV3 += "</Line>";
                LineCount = LineCount + 1;
            }
            if (oQuickEL.VendorFuelSurchargeAmt1 > 0)//AccountRef : 41(Fuel Expenses)[QB LIVE] / 41 (Interest Expenses)[QB Test]
            {
                vendorAmtAddV3 += "<Line><Id>" + LineCount.ToString() + "</Id>";
                vendorAmtAddV3 += "<Amount>" + Convert.ToString(oQuickEL.VendorFuelSurchargeAmt1.ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
                vendorAmtAddV3 += "<Description></Description>";
                vendorAmtAddV3 += "<DetailType>AccountBasedExpenseLineDetail</DetailType><AccountBasedExpenseLineDetail><AccountRef>41</AccountRef></AccountBasedExpenseLineDetail>";
                vendorAmtAddV3 += "</Line>";
                LineCount = LineCount + 1;
            }

            if (oQuickEL.VendorInsuranceAmt > 0)//AccountRef : 11(Insurance)[QB LIVE] / 11 (Dues & Subscription)[QB Test]
            {
                vendorAmtAddV3 += "<Line><Id>" + LineCount.ToString() + "</Id>";
                vendorAmtAddV3 += "<Amount>" + Convert.ToString(oQuickEL.VendorInsuranceAmt.ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
                vendorAmtAddV3 += "<Description></Description>";
                vendorAmtAddV3 += "<DetailType>AccountBasedExpenseLineDetail</DetailType><AccountBasedExpenseLineDetail><AccountRef>11</AccountRef></AccountBasedExpenseLineDetail>";
                vendorAmtAddV3 += "</Line>";
                LineCount = LineCount + 1;
            }

            if ((oQuickEL.VendorCODFeeAmt + oQuickEL.VendorTransportAmt1) > 0)//AccountRef : 31(Cost of Goods Sold)[LIVE];57[QB Test] / 31 (Cost of labor - COS)[QB Test]
            {
                vendorAmtAddV3 += "<Line><Id>" + LineCount.ToString() + "</Id>";
                vendorAmtAddV3 += "<Amount>" + Convert.ToString((oQuickEL.VendorCODFeeAmt + oQuickEL.VendorTransportAmt1).ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
                vendorAmtAddV3 += "<Description></Description>";
                vendorAmtAddV3 += "<DetailType>AccountBasedExpenseLineDetail</DetailType><AccountBasedExpenseLineDetail><AccountRef>31</AccountRef></AccountBasedExpenseLineDetail>";
                vendorAmtAddV3 += "</Line>";                
            }
            */
            vendorAmtAddV3 += "<TxnDate>" + DateTime.Now.ToString("yyyy-MM-dd") + "</TxnDate>";
            vendorAmtAddV3 += "<VendorRef>" + oQuickEL.VendorName.Trim().Replace("&", "&amp;") + "</VendorRef>";
            vendorAmtAddV3 += "<DocNumber></DocNumber>";
            vendorAmtAddV3 += "</Bill>";
            StreamWriter tw1 = null;
            string strToday1 = Convert.ToString(DateTime.Now.ToString("dd-MM-yyyy"));
            ...
            tw1 = new StreamWriter(UnProcessedWithoutPronumberPath + Filename, true);
            tw1.WriteLine(vendorAmtAddV3);
            tw1.Close();
            //QB REST V3 API
            //return vendoeAdd;
        ...
        public string PrepareCustomerAddXML(QuickBookEL oQuickEL)
        {
            ...
            //QB REST V3 API
            string CustomerAddV3 = "";

            CustomerAddV3 += @"<Customer xmlns=""http://schema.intuit.com/finance/v3"" domain=""QBO"" sparse=""false"">";
            CustomerAddV3 += "<DisplayName>" + Convert.ToString(oQuickEL.CustomerName).Trim().Replace("&", "&amp;") + "</DisplayName>";
            CustomerAddV3 += "<CompanyName>" + Convert.ToString(oQuickEL.CustomerCompanyName).Trim().Replace("&", "&amp;") + "</CompanyName>";
            CustomerAddV3 += "<PrimaryEmailAddr>";
            CustomerAddV3 += "<Address>" + Convert.ToString(oQuickEL.CustomerEmail).Trim().Replace("&", "&amp;") + "</Address>";
            CustomerAddV3 += "</PrimaryEmailAddr>";
            CustomerAddV3 += "</Customer>";
        ...
        public string PrepareCustomerAmtAddXML(QuickBookEL oQuickEL)
        {
            ...
            vendoeAdd += "</ItemRef>";
            vendoeAdd += "<Desc>" + Convert.ToString(oQuickEL.CustomerInvoiceDesc).Trim().Replace("&", "&amp;").Replace("–", "-") + "</Desc>";
            ...
            //QB REST V3 API
            string customerAmtAddV3 = "";
            //string iCustomerName = Convert.ToString(oQuickEL.CustomerName).Trim().Replace("&", "&amp;");
            //localhost.WebService1 oWebService1 = new localhost.WebService1();
            //string iCustomerID = oWebService1.GetCustomerID(iCustomerName);
            customerAmtAddV3 += @"<Invoice xmlns=""http://schema.intuit.com/finance/v3"">
  <Line>
    <Amount>" + Convert.ToString(oQuickEL.CustomerTotalAmt.ToString("#0.00")).Trim().Replace("&", "&amp;") + "</Amount>";
            customerAmtAddV3 += "<Description>" + Convert.ToString(oQuickEL.CustomerInvoiceDesc).Trim().Replace("&", "&amp;").Replace("–", "-") + "</Description>";
            customerAmtAddV3 += "<DetailType>SalesItemLineDetail</DetailType>";
            customerAmtAddV3 += "<SalesItemLineDetail><ItemRef>1</ItemRef>";
            //customerAmtAddV3 +="<Qty>" + Convert.ToString(oQuickEL.CustomerTotalQty).Trim().Replace("&", "&amp;") + "</Qty>";
            customerAmtAddV3 += "<Qty>" + "1" + "</Qty>";
            customerAmtAddV3 += "<UnitPrice>" + Convert.ToString(oQuickEL.CustomerTotalAmt.ToString("#0.00")).Trim().Replace("&", "&amp;") + "</UnitPrice>";
            customerAmtAddV3 += "</SalesItemLineDetail>";
            customerAmtAddV3 += "</Line>";
            customerAmtAddV3 += "<CustomerRef>" + Convert.ToString(oQuickEL.CustomerName).Trim().Replace("&", "&amp;") + "</CustomerRef>";
            customerAmtAddV3 += "<DocNumber>" + Convert.ToString(oQuickEL.CustomerInvoiceNo).Trim().Replace("&", "&amp;") + "</DocNumber>";
            //customerAmtAddV3 += "<PrivateNote>" + Convert.ToString(oQuickEL.CustomerInvoiceNo).Trim().Replace("&", "&amp;") + "</PrivateNote>";
            customerAmtAddV3 += "</Invoice>";
            ...
            StreamWriter tw1 = null;
            string strToday1 = Convert.ToString(DateTime.Now.ToString("dd-MM-yyyy"));
            string Filename = strToday1 + System.Guid.NewGuid().ToString().Substring(0, 8) + "QBV3xmlcustomerAmtAdd.txt";
            //tw1 = new StreamWriter(Server.MapPath("../QBFiles/UnProcessed/" + Filename), true);
            tw1 = new StreamWriter(UnProcessedPath + Filename, true);
            tw1.WriteLine(customerAmtAddV3);
            tw1.Close();
            //QB REST V3 API
            //return vendoeAdd;
            return Filename;
        ...
        public string AddQWEVendor2QuickBook(string strRefNo)
        {
            // Add Vendor to Quickbook
            QuickBookEL oQuickBookEL = new QuickBookEL();
            oQuickBookEL.CustomerInvoiceNo = Convert.ToString(strRefNo);
        ...
        #region public string PrepareQWEVendorAddXML(int CarrierID, string CarrierType)
        public string PrepareQWEVendorAddXML()
        {
            ...
            StreamWriter tw = null;
            string strToday = Convert.ToString(DateTime.Now.ToString("dd-MM-yyyy"));
            //string FileName = strToday + "QBxml.txt";
            //tw = new StreamWriter(Server.MapPath("../QBFiles/UnProcessed/" + strToday + "QBxml.txt"), true);
            tw = new StreamWriter(UnProcessedPath + strToday + "QBxml.txt", true);
            tw.WriteLine(vendoeAdd);
            tw.Close();
            ...
            string vendorAddV3 = "";
            vendorAddV3 += @"<Vendor xmlns=""http://schema.intuit.com/finance/v3"" sparse=""false"">";
            vendorAddV3 += "<DisplayName>" + Convert.ToString(drpBillToCompany.SelectedItem.Text).Trim().Replace("&", "&amp;") + "</DisplayName>";
            vendorAddV3 += "<Active>true</Active>";
            vendorAddV3 += "<PrimaryPhone>";
            vendorAddV3 += "<FreeFormNumber>" + "</FreeFormNumber>";
            vendorAddV3 += "</PrimaryPhone>";
            vendorAddV3 += "<Fax>";
            vendorAddV3 += "<FreeFormNumber>" + "</FreeFormNumber>";
            vendorAddV3 += "</Fax>";
            vendorAddV3 += "<PrimaryEmailAddr>";
            vendorAddV3 += "<Address>" + "</Address>";
            vendorAddV3 += "</PrimaryEmailAddr>";
            vendorAddV3 += "<BillAddr>";
            vendorAddV3 += "<Line1>" + Convert.ToString(txtBillToAddress.Text).Trim().Replace("&", "&amp;") + "</Line1>";
            vendorAddV3 += "<City>" + Convert.ToString(txtBillToCity.Text).Trim().Replace("&", "&amp;") + "</City>";
            vendorAddV3 += "<Country></Country>";
            vendorAddV3 += "<PostalCode>" + Convert.ToString(txtBillToZip.Text).Trim().Replace("&", "&amp;") + "</PostalCode>";
            vendorAddV3 += "</BillAddr>";
            vendorAddV3 += "</Vendor>";
        ...
        #endregion public string PrepareQWEVendorAddXML(int CarrierID, string CarrierType)
    }
}
