<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLocationPopInter.aspx.cs"
    Inherits="ISCS.Admin.UserLocationPopInter" Theme="Admin" %>
    ...
    <script type="text/javascript" language="javascript">
         function SelectLocation(imgId) {
             ...
             arrImgId = imgId.split("_");             
                 ...
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtIntermediateConsignee.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsName").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtContactName.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsContact").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtAddress.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsAddress").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtTelephone.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsPhone").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtCity.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsCity").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_txtPostalCode.value = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsPostalCd").innerHTML;
                 var input3 = document.getElementById("gridUserLocations_" + arrImgId[1] + "_lblInterConsCountryInd").innerHTML;
                 window.parent.parent.document.aspnetForm.ctl00_ContentPlaceHolder1_drpCountry.value = input3;
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <asp:Label ID="lblInterCons" Style="font-weight: bold" runat="server" Text="Intermediate Consignee :"></asp:Label>
                                    <br />
                                    <label>
                                        Name :</label>
                                    <asp:Label ID="lblInterConsName" runat="server" Text='<%# Eval("ExportIntermediateConsignee") %>'></asp:Label><br />
                                    <label>
                                        Address :</label>
                                    <asp:Label ID="lblInterConsAddress" runat="server" Text='<%# Eval("ExportAddress") %>'></asp:Label><br />
                                    <label>
                                        City :</label>
                                    <asp:Label ID="lblInterConsCity" runat="server" Text='<%#  Eval("ExportCity") %>'></asp:Label><br />
                                    <label>
                                        Postal Code:
                                    </label>
                                    <asp:Label ID="lblInterConsPostalCd" runat="server" Text='<%# Eval("ExportPostalCode") %>'></asp:Label><br />
                                    <label>
                                        Country :</label>
                                    <asp:Label ID="lblInterConsCountry" runat="server" Text='<%# Eval("ExportCountry") %>'></asp:Label><br />
                                    <label>
                                        Contact :</label>
                                    <asp:Label ID="lblInterConsContact" runat="server" Text='<%# Eval("ExportIntermediateContact") %>'></asp:Label><br />
                                    <label>
                                        Phone :</label>
                                    <asp:Label ID="lblInterConsPhone" runat="server" Text='<%# Eval("ExportIntermediatePhone") %>'></asp:Label><br />
                                    <asp:Label ID="lblInterConsCountryInd" Style="display: none;" runat="server" Text='<%# Eval("ExportCountrySelectedIndex") %>'></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
