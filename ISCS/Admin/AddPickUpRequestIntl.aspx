<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="AddPickUpRequestIntl.aspx.cs" Inherits="ISCS.Admin.AddPickUpRequestIntl"
    Theme="Admin" MaintainScrollPositionOnPostback="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Openskidpop(reqid) {
            ...
            GB_show("Skids Details", "../../admin/SkidsDetailsInt.aspx?pickuprequestid=" + reqid, 430, 780);
        ...
        function OpenShippop(reqid, huid, shipid) {
            ...
            GB_show("Shipment Items", "../../admin/SkidsDetailsInt.aspx?sec=ship&pickuprequestid=" + reqid + "&huid=" + huid + "&shipid=" + shipid, 430, 780);
        ...
        function OpenHupop(huid) {
            ...
            GB_show("Handling Unit", "../../admin/SkidsDetailsInt.aspx?sec=hu&huid=" + huid, 430, 780);
        ...
        function OpenAddShippop(reqid, huid) {
            ...
            GB_show("Shipment Items", "../../admin/SkidsDetailsInt.aspx?addship=addship&pickuprequestid=" + reqid + "&huid=" + huid, 430, 780);
...
//                document.getElementById('ctl00_ContentPlaceHolder1_txtBillToCountry').value = 'United States';
        ...
        function EnableModeOfTransport(strRadioID) {
            document.getElementById('<%=drpInternAirTypeService1.ClientID %>').disabled = true;
            document.getElementById('<%=drpInternAirTypeService2.ClientID %>').disabled = true;
            document.getElementById('<%=drpInternOceanTypeService1.ClientID %>').disabled = true;
            document.getElementById('<%=drpInternOceanTypeService2.ClientID %>').disabled = true;

            if (strRadioID == 'rbInternAir') {
                document.getElementById('<%=drpInternAirTypeService1.ClientID %>').disabled = false;
                document.getElementById('<%=drpInternAirTypeService2.ClientID %>').disabled = false;
            }
            if (strRadioID == 'rbInternOcean') {
                document.getElementById('<%=drpInternOceanTypeService1.ClientID %>').disabled = false;
                document.getElementById('<%=drpInternOceanTypeService2.ClientID %>').disabled = false;
            }
        }
        function FirtTimeModeOfTransport() {
            if (document.getElementById('<%=drpInternAirTypeService1.ClientID %>') == null || document.getElementById('<%=drpInternOceanTypeService1.ClientID %>') == null) {
                return;
            }
            document.getElementById('<%=drpInternAirTypeService1.ClientID %>').disabled = true;
            document.getElementById('<%=drpInternAirTypeService2.ClientID %>').disabled = true;
            ...
            if (document.getElementById('<%=rbInternAir.ClientID %>').checked == true) {
                document.getElementById('<%=drpInternAirTypeService1.ClientID %>').disabled = false;
                document.getElementById('<%=drpInternAirTypeService2.ClientID %>').disabled = false;
            }
            if (document.getElementById('<%=rbInternOcean.ClientID %>').checked == true) {
                document.getElementById('<%=drpInternOceanTypeService1.ClientID %>').disabled = false;
                document.getElementById('<%=drpInternOceanTypeService2.ClientID %>').disabled = false;
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rht-cont">
        <div class="serviceBox" style="background-color: #2F0018!important;">
            <h2>
                Pickup Request <span style="color: rgb(253, 255, 0)!important; font-size: 20px;">International</span></h2>
            ...
            <div class="whiteBox">
                    ...
                    <tbody>
                        <tr>
                            <td class="body_text_12" colspan="5">
                                <h3 style="background-color: #005F04!important;">
                                    Quick Addition</h3>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="body_text_12" align="right" valign="middle" style="padding: 0 10px 0 0;">
                                ...
                                <label>
                                    Exporter's EIN(IRS) No :
                                </label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtExporterEIN" MaxLength="20" runat="server"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="reqExporterEIN" ControlToValidate="txtExporterEIN"
                                    SetFocusOnError="true" ValidationGroup="location" Display="Dynamic" runat="server"
                                    ErrorMessage="Please enter exporter's EIN(IRS) no"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="body_text_12" align="right" valign="middle" style="padding: 0 10px 0 0;">
                                <label>
                                    Parties To Transaction :</label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chkPartyTransaction" runat="server" />
                            </td>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="padding-bottom: 8px">
                                <a href="UserLocationPopInter.aspx" onclick="return GB_show('Location', this.href)">
                        ...
                        <tr>
                            <td class="body_text_12" align="right" valign="middle" style="padding: 0 10px 0 0;">
                                <label>
                                    Intermediate Consignee:</label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtIntermediateConsignee" runat="server"></asp:TextBox>
                            </td>
                            <td class="body_text_12" align="right" valign="middle" style="padding: 0 10px 0 0;">
                                <label>
                                    Contact Name :</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtValidLicenseNo" runat="server"></asp:TextBox>
                            </td>
                            <td class="body_text_12" align="right" valign="middle" style="padding: 0 10px 0 0;">
                                <label>
                                    ECCN (when required):
                            ...
                            <td>
                                <asp:TextBox ID="txtECCN" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                ...
                <table id="tblHandlingdetails" runat="server" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <asp:GridView ID="gridHandlingUnits" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataListI"
                                    Width="100%" AllowPaging="True" PageSize="10" AllowSorting="true" OnRowDataBound="gridHandlingUnits_RowDataBound"
                                    OnPageIndexChanging="gridHandlingUnits_PageIndexChanging" GridLines="None" PagerStyle-CssClass="pgr">
                ...
                <table id="tblShipmentItems" runat="server" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <asp:GridView ID="gridShipments" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataListI"
                                    Width="100%" AllowPaging="True" PageSize="10" AllowSorting="true" OnPageIndexChanging="gridShipments_PageIndexChanging"
                                    GridLines="None" PagerStyle-CssClass="pgr" OnRowDataBound="gridShipments_RowDataBound">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="60px" HeaderText="Unit Id">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="D/F">
                                            <ItemTemplate>
                                                <asp:Label ID="lblExportMFG" Text='<%# Eval("Export_MFG_SI")%>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100px" HeaderText="Harmonized Code">
                                            <ItemTemplate>
                                                <asp:Label ID="lblHarmonizedCode" Text='<%# Eval("ExportScheduleB_SI")%>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="body_text_12" align="left" valign="middle" style="padding: 0 5px 0 40px;">
                                <asp:RadioButton ID="rbInternAir" GroupName="reqservice" CssClass="redio" Text="International Air"
                                    runat="server" />
                            </td>
                            <td>
                                <asp:DropDownList ID="drpInternAirTypeService1" Width="120px" runat="server">
                                </asp:DropDownList>
                                <asp:DropDownList ID="drpInternAirTypeService2" Width="155px" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="body_text_12" align="left" valign="middle" style="padding: 0 5px 0 40px;">
                                <asp:RadioButton ID="rbInternOcean" GroupName="reqservice" CssClass="redio" Text="International Ocean"
                                    runat="server" />
                            </td>
                            <td>
                                <asp:DropDownList ID="drpInternOceanTypeService1" runat="server">
                                </asp:DropDownList>
                                &nbsp;
                                <asp:DropDownList ID="drpInternOceanTypeService2" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                ...
                <table id="tabInsuranceRequired" runat="server">
                    <tr>
                        <td>
                            Insurance Required?
                        </td>
                        <td>
                            <asp:RadioButtonList ID="rbInsuranceRequired" RepeatDirection="Horizontal" CssClass="radioship"
                                runat="server">
                        ...
                        <td>
                            <asp:TextBox ID="txtInsuredValue" MaxLength="14" onkeypress="return onlyDigits(event,'decOK')"
                                runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table id="tblSpecialServices" runat="server" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="body_text_12" colspan="4">
                                <h3 style="background-color: #005F04!important;">
                                    Shippers Instructions</h3>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" align="center">
                                <textarea id="txtareaShippersInstructions" rows="5" class="textareawf" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="body_text_12" colspan="4">
                                <h3 style="background-color: #005F04!important;">
                                    Documents Enclosed</h3>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" align="center">
                                <textarea id="txtareaDocumentEnclosed" rows="5" class="textareawf" runat="server"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table id="tblShipmentInfo" runat="server" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtShippedWeight" onkeypress="return onlyDigits(event,'decOK')"
                        ...
                        <tr>
                            <td align="right">
                                <label>
                                    Port/Air Port of Export :
                                </label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtPortAirExport" MaxLength="14" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblistContainerized" RepeatDirection="Horizontal" CssClass="radioship"
                                    runat="server">
                                    <asp:ListItem Text="No" Selected="True" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                </asp:RadioButtonList>
                ...
                <table id="tblShipmentCharges" runat="server" cellspacing="0" cellpadding="0" border="1"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtBuyBrokerage" CssClass="tboxpickreq" MaxLength="14" onkeypress="return onlyDigits(event,'decOK')"
                                    runat="server"></asp:TextBox>
                            </td>
                            <td>
                                Brokerage
                            ...
                            <td>
                                <asp:TextBox ID="txtSellBrokerage" CssClass="tboxpickreq" MaxLength="14" onkeypress="return onlyDigits(event,'decOK')"
                                    runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtBuyDuty" CssClass="tboxpickreq" MaxLength="14" onkeypress="return onlyDigits(event,'decOK')"
                                    runat="server"></asp:TextBox>
                            </td>
                            <td>
                                Duty
                            ...
                            <td>
                                <asp:TextBox ID="txtSellDuty" CssClass="tboxpickreq" MaxLength="14" onkeypress="return onlyDigits(event,'decOK')"
                                    runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTotal1" MaxLength="14" onfocus="blur()" onkeypress="return onlyDigits(event,'decOK')"
                                    CssClass="tboxpickreq" runat="server"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="txtTotal" MaxLength="14" onfocus="blur()" onkeypress="return onlyDigits(event,'decOK')"
                                    CssClass="tboxpickreq" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </tbody>
