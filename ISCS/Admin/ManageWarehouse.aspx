<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="ManageWarehouse.aspx.cs" Inherits="ISCS.Admin.ManageWarehouse" Theme="Admin" %>
            ...
            <div class="whiteBox userListPan">
                <table width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span style="padding-top: 10px;"><a href="ManageWarehouse.aspx">View All</a></span>
                            </td>
                            <td align="right">
                                <a href="#">&nbsp;</a>
                            </td>
                                    ...
                                    <asp:GridView ID="gridUsers" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataList"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkmaskedskidClick" Text='<%# Eval("maskedskid")%>' runat="server"
                                                        ...
                                                        PostBackUrl="~/Admin/ManageWarehouseSku.aspx"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                <HeaderTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="lnkavailableqty" CommandName="sortavailableqty" Text="Available Qty"
                                                        runat="server"></asp:LinkButton>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="95px"
                                                ItemStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="lnkreceiptdate" CommandName="sortreceiptdate" Text="Receipt Date"
                                                        runat="server"></asp:LinkButton>
                                                </HeaderTemplate>
                                                <ItemTemplate>
