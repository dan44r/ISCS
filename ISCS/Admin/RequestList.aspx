<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="RequestList.aspx.cs" Inherits="ISCS.Admin.RequestList" Theme="Admin" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div>
                                    ...
                                    <asp:GridView ID="gridNonPending" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataList"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a id="ancBill" runat="server">
                                                        <img src="../Images/view_icon.gif" /></a>
                                                    <asp:Label ID="lblRequestTypeNP" runat="server" Visible="false" Text='<%# Eval("PickupRequestType") %>'></asp:Label>
                                                    <asp:ImageButton ID="btnEditUserNP" runat="server" CommandArgument='<%#Eval("PickupRequestId") %>'
                                                        ImageUrl="../Images/edit.gif" OnClick="btnEditUserNP_Click" ToolTip="Edit" Width="16px" />&nbsp;
                                    ...
                                    <asp:GridView ID="gridPending" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataList"
                                        Width="100%" AllowPaging="True" PageSize="10" AllowSorting="true" OnRowDataBound="gridPending_RowDataBound"
                                        OnPageIndexChanging="gridPending_PageIndexChanging" OnRowCommand="gridPending_RowCommand"
                                        GridLines="None" PagerStyle-CssClass="pgr">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="btnEditUserP" runat="server" CommandArgument='<%#Eval("PickupRequestId") %>'
                                                        ImageUrl="../Images/edit.gif" OnClick="btnEditUserP_Click" ToolTip="Edit" Width="16px" />&nbsp;
                                                    <asp:ImageButton ID="btnDeleteUser" runat="server" OnClientClick="return confirm('Are you sure you want to delete ?')"
                                                        CommandArgument='<%# Eval("PickupRequestId")%>' ImageUrl="../images/delete.gif"
                                                        OnClick="btnDeleteUser_Click" ToolTip="Delete" Width="16px" />
                                    ...
                                    <asp:GridView ID="gridAll" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataList"
                                        Width="100%" AllowPaging="True" PageSize="10" AllowSorting="true" OnRowDataBound="gridAll_RowDataBound"
                                        OnPageIndexChanging="gridAll_PageIndexChanging" OnRowCommand="gridAll_RowCommand"
                                        GridLines="None" PagerStyle-CssClass="pgr">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAllRequestType" runat="server" Visible="false" Text='<%# Eval("PickupRequestType") %>'></asp:Label>
                                                    <asp:Label ID="lblToContact" Text='<%# Eval("ToContact")%>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
