<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillOfLading_Vics.aspx.cs"
    Inherits="ISCS.BillOfLading_Vics" %>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="40%" valign="top">
                                ...
                                <br>
                                Tel: 508.210.2164&nbsp;<br>
                                <%--Tel Main: 508 444-0332&nbsp;--%>Fax: 508.210.2158<br>
                        ...
                        <tr>
                            <td colspan="2" width="100%" align="center">
                                ...
                                <table align="center" border="0" bordercolor="#0000FF" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                                        ...
                                                                        <table border="0" width="100%" cellspacing="0" cellpadding="1">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" align="left">
                                                                                    ...
                                                                                    <span><b>Address:</b></span>&nbsp;<asp:Label ID="lblstrShipFromAddress" runat="server"
                                                                                        Text=""></asp:Label><br>
                                                                                    <span><b>City/State/Zip:</b></span>&nbsp;<asp:Label ID="lblstrShipFromCity" runat="server"
                                                                                        Text=""></asp:Label>,
                                                                                    <asp:Label ID="lblstrShipFromState" runat="server" Text=""></asp:Label>&nbsp;<asp:Label
                                                                                        ID="lblstrShipFromPostalCode" runat="server" Text=""></asp:Label><br>
                                                                                    <span><b>SID#:</b></span>&nbsp;<asp:Label ID="lblstrShipFromRefNumber" runat="server"
                                                                                        Text=""></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td valign="top" align="left">
                                                                                    <span><b>Contact:</b></span>&nbsp;<asp:Label ID="lblstrShipFromContact" runat="server"
                                                                                        Text=""></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="50%" valign="top" align="left">
                                                                                    <span><b>Tel:</b></span>&nbsp;<asp:Label ID="lblstrShipFromPhone" runat="server"
                                                                                        Text=""></asp:Label>&nbsp;<span><b>Fax:</b></span>&nbsp;<asp:Label ID="lblstrShipFromFax"
                                                            ...
                                                            <td width="50%" valign="top" rowspan="3">
                                                                ...
                                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                    ...
                                                                    <tr>
                                                                        <td class="BorderB" align="left">
                                                                            <span><b>CARRIER NAME:</b></span>&nbsp;<asp:Label ID="lblstrGLSCarrierName" runat="server"
                                                                                Text=""></asp:Label><br>
                                                                            Trailer number:<br>
                                                                            Seal number(s):
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td width="60%" valign="top">
                                                                ...
                                                                <table border="0" width="100%" cellspacing="0" cellpadding="2" id="table1">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="left">
                                                                            <span><b>Name:</b></span>&nbsp;<asp:Label ID="lblstrShiptoCompany" runat="server"
                                                                                Text=""></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;Location#:<br>
                                                                            <span><b>Address:</b></span>&nbsp;<asp:Label ID="lblstrShiptoAddress" runat="server"
                                                                                Text=""></asp:Label><br>
                                                                            <span><b>City/State/Zip:</b></span>&nbsp;<asp:Label ID="lblstrShiptoCity" runat="server"
                                                                                Text=""></asp:Label>,<asp:Label ID="lblstrShiptoState" runat="server" Text=""></asp:Label>&nbsp;<asp:Label
                                                                                    ID="lblstrShiptoPostalCode" runat="server" Text=""></asp:Label><br>
                                                                            <span><b>CID#:</b></span>&nbsp;<asp:Label ID="lblstrShipToConsigneeRefNumber" runat="server"
                                                                                Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td valign="top" align="left">
                                                                            <span><b>Contact:</b></span>&nbsp;<asp:Label ID="lblstrShipToContact" runat="server"
                                                                                Text=""></asp:Label>&nbsp; <span><b>Tel:</b></span>&nbsp;<asp:Label ID="lblstrShipToPhone"
                                                                                    runat="server" Text=""></asp:Label>&nbsp;<span><b>Fax:</b></span>&nbsp;<asp:Label
                                                                                        ID="lblstrShipToFax" runat="server" Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="50%" valign="top" align="left">
                                                                            <span><b>Also Notify:</b></span>&nbsp;<asp:Label ID="lblstrShipToNotifyName" runat="server"
                                                                                Text=""></asp:Label>&nbsp;<span><b>Tel:</b></span>&nbsp;<asp:Label ID="lblstrShipToNotifyPhone"
                                                                                    runat="server" Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="left">
                                                                            ...
                                                                            <asp:Label ID="lblstrGLSBillState" runat="server" Text=""></asp:Label>&nbsp;<asp:Label
                                                                                ID="lblstrGLSBillPostalCode" runat="server" Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!--End Inner Table 4 -->
                                    ...
                                    <td colspan="2" valign="top" align="left" style="padding-top: 5px; padding-bottom: 5px;
                                        color: red; background-color: rgb(239, 255, 111);">
                                        <b>SPECIAL INSTRUCTIONS:
                                            <asp:Label ID="lblstrTransModeName" runat="server" Text=""></asp:Label>&nbsp;-&nbsp;<asp:Label
                                                ID="lblstrTransModeService1" runat="server" Text=""></asp:Label></b>
                                        <br>
                                        <b>
                                            <asp:Label ID="lblstrSpecialInstructions" runat="server" Text=""></asp:Label></b>
                                    </td>
                        </tr>
                        <%
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gridShipmentItems" runat="server" AutoGenerateColumns="false" CssClass="mGrid dataList"
                                                CellPadding="0" CellSpacing="0" Width="100%" AllowPaging="True" PageSize="10"
                                                AllowSorting="true" BorderColor="#808080" BorderWidth="1px" Style="border-collapse: collapse"
                                                OnRowDataBound="gridShipmentItems_RowDataBound" ShowFooter="true" PagerStyle-CssClass="pgr">
