...
namespace ISCS
{
    public partial class KeyManagement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            HtmlAnchor lnk = new HtmlAnchor();

            lnk = this.Master.FindControl("lnkCompany") as HtmlAnchor;
            if (lnk != null)
        ...
        protected void FillContent()
        {
            ...
            objEl = BusinessLogicLayer.IscsCms.FetchSingleContent(3);
